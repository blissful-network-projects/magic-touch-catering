          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-[#9B8FC7]/30 text-[#9B8FC7] hover:bg-[#9B8FC7] hover:text-white transition-all duration-300 flex items-center justify-center"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-[#A8C4A0]/30 text-[#A8C4A0] hover:bg-[#A8C4A0] hover:text-white transition-all duration-300 flex items-center justify-center"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
